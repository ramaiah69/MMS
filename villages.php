...
<?php
	...
	if(isset($_POST['submit']))
	{
		...
		if(!empty($_POST['title']) && !empty($_POST['about']) && !empty($_POST['date']) && !empty($_POST['s_procedure']) && !empty($_POST['budget']) && !empty($_POST['status']) && !empty($_POST['officials']) && !empty($_POST['website']) && !empty($_POST['department']))
		{
			...
			$query=mysql_query("insert into scheme_details (name,starting_date,about,s_procedure,total_budget,status,officials,website,department) values('$name','$date','$about','$s_procedure','$budget','$status','$officials','website','$department')");
