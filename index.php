                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="body">
                                <ul class="menu">
									<?php
										require "requires/connect.php";
										$a=mysql_query("select * from notifications");
										while($data=mysql_fetch_assoc($a))
										{
											echo '<li>';
												echo '<a href="javascript:void(0);">';
													echo '<div class="icon-circle bg-cyan">';
														echo '<i class="material-icons">person_add</i>';
													echo '</div>';
													echo '<div class="menu-info">';
														...
														$time=date("H:i:s");
														$new=strtotime($data['date_post']);
														$b=date("H:i:s",$new);
														$time=$time-$b;
														
															echo '<i class="material-icons"></i>'.$time."Mins ago";
														echo '</p>';
													echo '</div>';
												echo '</a>';
											echo '</li>';
				...
				<a href="schemes.php">
					<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
						<div class="info-box bg-pink hover-expand-effect">
							...
							<div class="content">
								<div class="text">SCHEMES</div>
								<div class="number count-to" data-from="0" data-to="
								<?php
								$query=mysql_query("select count(*) from scheme_details");
								$query=mysql_fetch_array($query);
								echo $query[0];
								?>
                    ...
                    <div class="info-box bg-cyan hover-expand-effect">
                        <div class="icon">
							...
							<div class="content">
								...
								<div class="number count-to" data-from="0" data-to="
								 <?php
									$query=mysql_query("select count(*) from queries where answered_status=0");
									$query=mysql_fetch_array($query);
									echo $query[0];
								?>
					...
					<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
						<div class="info-box bg-light-green hover-expand-effect">
							...
							<div class="content">
								...
								<div class="number count-to" data-from="0" data-to="
								 <?php
									$query=mysql_query("select count(*) from feedback where view=0");
									$query=mysql_fetch_array($query);
									echo $query[0];
								?>
								" data-speed="1000" data-fresh-interval="20"></div>
