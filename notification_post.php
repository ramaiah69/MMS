    ...
    <section class="content">
            ...
            <div class="body">
                <form id="sign_up" method="POST">
                    <div class="msg">POST NOTIFICATION</div>
                    ...
                    <div class="input-group">
                        ...
                        <div class="form-line">
                           <select name="district" class="form-control">
							   <option name="district"  selected>Select a District</option>
							   <?php
									require "requires/connect.php";
									$query=mysql_query("select * from district_details");
					...
					<div class="input-group">
                        ...
                        <div class="form-line">
                           <select name="mandal" class="form-control">
							   <option name="question" selected>Select a mandal</option>
							   <option name="question" value="all" >All</option>
							   <?php
									
									$query=mysql_query("select * from mandal_details");
									while($data=mysql_fetch_assoc($query))
									{
										echo '<option name="scheme" value="'.$data['m_name'].'">'.$data['m_name'].'</option>';
									}
							   ?>
                           </select>
                        </div>
                    ...
                    <div class="input-group">
                        ...
                        <div class="form-line">
                           <select name="village" class="form-control">
							   <option name="village" selected>Select a village</option>
							   <option name="village" value="all" >All</option>
							   <?php
									
									$query=mysql_query("select * from village_details");
									while($data=mysql_fetch_assoc($query))
									{
										echo '<option name="village" value="'.$data['v_name'].'">'.$data['v_name'].'</option>';
									}
							   ?>
                           </select>
                        </div>
...
<?php
	if(isset($_POST['submit']))
	{
		...
		if(!empty($_POST['title']) && !empty($_POST['description']) && !empty($_POST['district']) && !empty($_POST['mandal']) && !empty($_POST['village']))
		{
			...
			$district=mysql_real_escape_string(test_input($_POST['district']));
			$mandal=mysql_real_escape_string(test_input($_POST['mandal']));
			$village=mysql_real_escape_string(test_input($_POST['village']));
			...
			$query=mysql_query("insert into notifications (title,description,send_by,date_post,mandal,village,district,allow) values('$title','$description','$name','$date','$mandal','$village','$district','1')");
