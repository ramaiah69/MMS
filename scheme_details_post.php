            ...
            <div class="body">
                <form id="sign_up" method="POST">
                    ...
                    <div class="input-group">
                        ...
                        <div class="form-line">
                            <textarea type="text" class="form-control" name="about" placeholder="about" rows="4"></textarea>
                        </div>
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon">
                        ...
                        <div class="form-line">
                            <textarea type="text" class="form-control" name="s_procedure" placeholder="procedure" rows="4"></textarea>
                        </div>
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon">
                        ...
                        <div class="form-line">
                            <input type="text" class="form-control" name="date" placeholder="starting date(yyyy-mm-dd)" required>
                        </div>
                    </div>
                     <div class="input-group">
                        <span class="input-group-addon">
                        ...
                        <div class="form-line">
                            <input type="number" class="form-control" name="budget" placeholder="total budget" required>
                        </div>
                    </div>
                     <div class="input-group">
                        <span class="input-group-addon">
                     ...
                     <div class="input-group">
                        ...
                        <div class="form-line">
                            <input type="text" class="form-control" name="officials" placeholder="officials" required>
                        </div>
                    </div>
                     <div class="input-group">
                        <span class="input-group-addon">
                    ...
                    <div class="input-group">
                        ...
                        <div class="form-line">
                           <select name="department" class="form-control">
							   <option name="department"  selected>Select a Department</option>
							   <?php
									require "requires/connect.php";
...
<?php
	...
	if(isset($_POST['submit']))
	{
		...
		if(!empty($_POST['title']) && !empty($_POST['about']) && !empty($_POST['date']) && !empty($_POST['s_procedure']) && !empty($_POST['budget']) && !empty($_POST['status']) && !empty($_POST['officials']) && !empty($_POST['website']) && !empty($_POST['department']))
		{
			...
			$query=mysql_query("insert into scheme_details (name,starting_date,about,s_procedure,total_budget,status,officials,website,department) values('$title','$date','$about','$s_procedure','$budget','$status','$officials','website','$department')");
			$a=mysql_query("select * from scheme_details where name like '$title'");
			$a=mysql_fetch_array($a);
			$a=$a['id'];
			$sql="CREATE TABLE z_scheme_".$a." ( `m_id` int(11) NOT NULL, `d_id` int(11) NOT NULL, `budget` bigint(20) NOT NULL ); ";
			mysql_query($sql);
			if($query)
			{
